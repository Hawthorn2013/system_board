...
system_board_0326_2034
认为I2C只能读一次原因在于单片机，打算从初始化上做文章。
近期5604问题频出。先是调试时不能显示c代码，pc指针一直蹦，后发现是工程问题。然后是0325晚上，本来调着很正常，跟叶川说了会儿话回来就出错了。flash烧写最后时出错"error in once status register during instruction execution"，满屏都是。但经测试程序烧进去了。0326把3个codewarrior都卸载掉，又用usbdeview删掉所有有关的驱动，重装2.10就好了。
