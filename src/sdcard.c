...
void init_DSPI_1(void)
{
	...
	DSPI_1.CTAR[0].R = 0x3E0A7729;	//TF卡 用于发送8bits 调整极性为1，相位为1，调整波特率为低速31.25kbit/s
	DSPI_1.CTAR[1].R = 0x38087726;  //OLED SPI 极性为0，相位为0，baud rate=625Kbit/s
	//DSPI_1.CTAR[2].R = 0x3E0A7729;  //L3G4200D SPI 极性为1，相位为1，baud rate=31.25kbit/s
	DSPI_1.CTAR[2].R = 0x3E0A7724;  //L3G4200D SPI 极性为1，相位为1，baud rate=1m/s
